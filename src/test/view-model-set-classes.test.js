...
describe('correctly places people pair data', () => {
  ...
  const expectedData = {
    ...
    shiftBackToRootFemale: [
      ...
      // ghost pairs:
      ['gen0root-ghost', ['gen0root', 'ghost', '', 'visible'] ],
      ['gen1pair0-ghost', ['gen1pair0', 'ghost', '', 'visible'] ],
      ['gen2pair0-ghost', ['gen2pair0', 'ghost', '', 'visible'] ],
      ['gen2pair1-ghost', ['gen2pair1', 'ghost', '', 'visible'] ],
      ['gen3pair0-ghost', ['gen3pair0', 'ghost', '', 'visible'] ],
      ['gen3pair1-ghost', ['gen3pair1', 'ghost', '', 'visible'] ],
      ['gen3pair2-ghost', ['gen3pair2', 'ghost', '', 'visible'] ],
      ['gen3pair3-ghost', ['gen3pair3', 'ghost', '', 'visible'] ],
      ['gen4pair0-ghost', ['gen4pair0', 'ghost', '', 'visible'] ],
      ['gen4pair1-ghost', ['gen4pair1', 'ghost', '', 'visible'] ],
      ['gen4pair2-ghost', ['gen4pair2', 'ghost', '', 'visible'] ],
      ['gen4pair3-ghost', ['gen4pair3', 'ghost', '', 'visible'] ],
      ['gen4pair4-ghost', ['gen4pair4', 'ghost', '', 'visible'] ],
      ['gen4pair5-ghost', ['gen4pair5', 'ghost', '', 'visible'] ],
      ['gen4pair6-ghost', ['gen4pair6', 'ghost', '', 'visible'] ],
      ['gen4pair7-ghost', ['gen4pair7', 'ghost', '', 'visible'] ]
    ]
  }
