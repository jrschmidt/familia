        ...
        shiftToChildFemaleRoot: {
          // ( results before resetClasses() )
            ...
            pairs: [
              ...
              // ghost pairs:
              ['gen0root-ghost', ['enter', 'ghost', 'normal', 'visible'] ],
              ['gen1pair0-ghost', ['gen0root', 'ghost', 'normal', 'visible'] ],
              ['gen2pair0-ghost', ['enter', 'ghost', 'normal', 'visible'] ],
              ['gen2pair1-ghost', ['gen1pair0', 'ghost', 'normal', 'visible'] ],
              ['gen3pair0-ghost', ['enter', 'ghost', 'compressed', 'visible'] ],
              ['gen3pair1-ghost', ['enter',  'ghost', 'compressed', 'visible'] ],
              ['gen3pair2-ghost', ['gen2pair0', 'ghost', 'compressed', 'visible'] ],
              ['gen3pair3-ghost', ['gen2pair1', 'ghost', 'compressed', 'visible'] ],
              ['gen4pair0-ghost', ['gen3pair0', 'ghost', '', 'no-show'] ],
              ['gen4pair1-ghost', ['gen3pair1', 'ghost', '', 'no-show'] ],
              ['gen4pair2-ghost', ['gen3pair2', 'ghost', '', 'no-show'] ],
              ['gen4pair3-ghost', ['gen3pair3', 'ghost', '', 'no-show'] ],
              ['gen4pair4-ghost', ['gen3pair0', 'ghost', '', 'no-show'] ],
              ['gen4pair5-ghost', ['gen3pair1', 'ghost', '', 'no-show'] ],
              ['gen4pair6-ghost', ['gen3pair2', 'ghost', '', 'no-show'] ],
              ['gen4pair7-ghost', ['gen3pair3', 'ghost', '', 'no-show'] ]
            ],
            ...
            connectors: [
              ...
              // ghost connectors:
              ['cnx-0-0-ghost', ['enter', 'ghost', 'visible']],
              ['cnx-1-0-ghost', ['cnx-0-0', 'ghost', 'visible']],
              ['cnx-1-1-ghost', ['enter', 'ghost', 'visible']],
              ['cnx-2-0-ghost', ['cnx-1-0', 'ghost', 'visible']],
              ['cnx-2-1-ghost', ['cnx-1-1', 'ghost', 'visible']],
              ['cnx-2-2-ghost', ['enter', 'ghost', 'visible']],
              ['cnx-2-3-ghost', ['enter', 'ghost', 'visible']],
              ['cnx-3-0-ghost', ['cnx-2-0', 'ghost', 'no-show']],
              ['cnx-3-1-ghost', ['cnx-2-1', 'ghost', 'no-show']],
              ['cnx-3-2-ghost', ['cnx-2-2', 'ghost', 'no-show']],
              ['cnx-3-3-ghost', ['cnx-2-3', 'ghost', 'no-show']],
              ['cnx-3-4-ghost', ['enter', 'ghost', 'no-show']],
              ['cnx-3-5-ghost', ['enter', 'ghost', 'no-show']],
              ['cnx-3-6-ghost', ['enter', 'ghost', 'no-show']],
              ['cnx-3-7-ghost', ['enter', 'ghost', 'no-show']]
