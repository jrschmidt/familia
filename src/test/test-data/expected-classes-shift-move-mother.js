export const expectedToMother = {
  ...
  pairs: [
    ...
    ['gen2pair0-ghost', ['none', 'ghost', 'faded', 'fade'] ],
    ['gen2pair1-ghost', ['gen1pair0', 'ghost', 'normal', 'visible'] ],
    ['gen3pair0-ghost', ['none', 'ghost', 'faded', 'fade'] ],
    ['gen3pair1-ghost', ['none', 'ghost', 'faded', 'fade'] ],
  ...
  connectors: [
    ...
    ['cnx-1-0-ghost', ['none', 'ghost', 'fade']],
    ['cnx-1-1-ghost', ['cnx-0-0', 'ghost', 'visible']],
    ['cnx-2-0-ghost', ['none', 'ghost', 'fade']],
    ['cnx-2-1-ghost', ['none', 'ghost', 'fade']],
