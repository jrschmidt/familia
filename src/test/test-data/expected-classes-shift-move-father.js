export const expectedToFather = {
  ...
  connectors: [
    ...
    // ghost connectors:
    ['cnx-0-0-ghost', ['none', 'ghost', 'fade']],
    ['cnx-1-0-ghost', ['cnx-0-0', 'ghost', 'visible']],
    ['cnx-1-1-ghost', ['none', 'ghost', 'fade']],
    ['cnx-2-0-ghost', ['cnx-1-0', 'ghost', 'visible']],
    ['cnx-2-1-ghost', ['cnx-1-1', 'ghost', 'visible']],
    ['cnx-2-2-ghost', ['none', 'ghost', 'fade']],
    ['cnx-2-3-ghost', ['none', 'ghost', 'fade']],
